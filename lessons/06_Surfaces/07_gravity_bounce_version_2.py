...
class Player:
    ...
    def update_pos(self):
        ...
        if self.at_left():
            self.pos.x = 0
            #pygame.draw.rect(Game.screen, Colors.PLAYER_COLOR, (self.pos.x, self.pos.y, self.width/1.2, self.height*1.2))
            squish_left = pygame.transform.scale(self.rectangle, (self.rectangle.width, self.rectangle.height * 2)) 
    ...
    def draw(self, screen):
        self.rectangle = pygame.draw.rect(screen, Colors.PLAYER_COLOR, (self.pos.x, self.pos.y, self.width, self.height))
